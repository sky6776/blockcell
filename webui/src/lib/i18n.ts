...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // Ghost
    'ghost.title': 'Ghost Maintenance',
    'ghost.settings': 'Settings',
    'ghost.activityLog': 'Activity Log',
    'ghost.description': 'Scheduled maintenance for memory gardening, file cleanup, and Community Hub sync. Embedded learning runs automatically during normal assistant use and does not depend on this switch.',
    'ghost.enableTitle': 'Enable Scheduled Maintenance',
    'ghost.enableDesc': 'Run background maintenance on a schedule. Embedded learning does not require this.',
    'ghost.model': 'Model',
    'ghost.modelHint': 'Select a configured model or enter a custom one. Scheduled maintenance uses this model for its background routine.',
    ...
    'ghost.maxSyncsHint': 'Limits how many scheduled maintenance cycles can run per day to control costs.',
    'ghost.autoSocial': 'Auto Social Interaction',
    'ghost.enableHubSync': 'Enable Community Hub Sync',
    'ghost.autoSocialHint': 'Scheduled maintenance will send heartbeats and check trending skills on the Community Hub.',
    'ghost.saveChanges': 'Save Changes',
    'ghost.saving': 'Saving...',
    'ghost.loadFailed': 'Failed to load Ghost config.',
    'ghost.noActivityTitle': 'No Maintenance Activity Yet',
    'ghost.noActivityDesc': 'Enable scheduled maintenance in Settings and background routine logs will appear here. Embedded learning runs during normal assistant use.',
  ...
  zh: {
    ...
    // Ghost
    'ghost.title': 'Ghost 后台维护',
    'ghost.settings': '设置',
    'ghost.activityLog': '活动日志',
    'ghost.description': '按计划执行记忆整理、文件清理和社区同步。它与对话过程中的嵌入式自学习是分开的，自学习不依赖这里的定时维护开关。',
    'ghost.enableTitle': '启用定时维护',
    'ghost.enableDesc': '按计划运行后台维护任务；嵌入式自学习不依赖此开关。',
    'ghost.model': '模型',
    'ghost.modelHint': '选择已配置的模型或输入自定义模型名。定时维护使用此模型执行后台例程。',
    ...
    'ghost.maxSyncsHint': '限制定时维护每天的运行次数以控制成本。',
    'ghost.autoSocial': '自动社交互动',
    'ghost.enableHubSync': '启用社区中心同步',
    'ghost.autoSocialHint': '定时维护将发送心跳并检查社区中心的热门技能。',
    'ghost.saveChanges': '保存更改',
    'ghost.saving': '保存中...',
    'ghost.loadFailed': '加载 Ghost 后台维护配置失败。',
    'ghost.noActivityTitle': '暂无维护活动',
    'ghost.noActivityDesc': '在设置中启用定时维护后，后台例程日志会显示在这里。嵌入式自学习会在正常对话中运行。',
